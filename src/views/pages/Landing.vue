                ...
                <div class="bg-surface-50 dark:bg-surface-800 p-8 rounded-lg shadow-lg">
                    ...
                    <div v-if="step === 1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <!-- Nome -->
                            <div class="mb-4">
                                <label for="name" class="block text-sm font-medium mb-2">Nome <span
                            ...
                            <!-- Sobrenome -->
                            <div class="mb-4">
                                <label for="sobrenome" class="block text-sm font-medium mb-2">Sobrenome <span
                                        class="text-red-500">*</span></label>
                            ...
                            <!-- Sexo -->
                            <div class="mb-4">
                                <label for="sexo" class="block text-sm font-medium mb-2">Sexo <span
                                        class="text-red-500">*</span></label>
                            ...
                            <!-- Idade -->
                            <div class="mb-4">
                                <label for="idade" class="block text-sm font-medium mb-2">Idade <span
                                        class="text-red-500">*</span></label>
                            ...
                            <!-- CPF -->
                            <div class="mb-4">
                                <label for="cpf" class="block text-sm font-medium mb-2">CPF <span
                                        class="text-red-500">*</span></label>
                    ...
                    <div v-if="step === 2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Telefone -->
                            <div class="mb-4">
                                <label for="telefone" class="block text-sm font-medium mb-2">Telefone <span
                                        class="text-red-500">*</span></label>
                            ...
                            <!-- Celular -->
                            <div class="mb-4">
                                <label for="celular" class="block text-sm font-medium mb-2">Celular <span
                                        class="text-red-500">*</span></label>
                    ...
                    <div v-if="step === 4">
                        ...
                        <div class="mb-4">
                            ...
                            <Divider />
                            <Checkbox v-model="form.lgpd" :binary="true" :class="{ 'p-invalid': errors.lgpd }" />
                            <label for="lgpd" class="ml-2 text-sm font-medium">Concordo com os termos acima. <span
                                    class="text-red-500">*</span></label>
...
export default {
    ...
    created() {
        // Captura o ID da rota quando o componente é criado
    ...
    methods: {
        ...
        // Consulta o CEP
        consultaCep() {
            this.form.CepService.buscaCep(this.form.cep).then((response) => {
                this.form.logradouro = response.logradouro;
